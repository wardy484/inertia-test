    ...
    [
      _c(
        "inertia-link",
        {
          ...
          attrs: { href: _vm.route("home.store"), method: "post" }
        },
        [_vm._v("Save")]
      ),
      _vm._v(" "),
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "px-5 py-3 bg-gray-200 flex justify-between items-center" },
    [
      _c("h1", { staticClass: "text-2xl font-bold" }, [_vm._v("YYDB")]),
      _vm._v(" "),
      _vm.$user
        ? _c(
            "div",
